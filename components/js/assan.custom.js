...
//shrink header
    ...
    $('.search-open').on('click', function () {
        {
            $('.search-inline').addClass('search-visible').find('input').focus();
            $('.search-inline-rtl').addClass('search-visible').find('input').focus();

        }
    });
    $('.search-close').on('click', function () {
        $('.search-inline').removeClass('search-visible').find('input').focus();
        $('.search-inline-rtl').removeClass('search-visible').find('input').focus();
